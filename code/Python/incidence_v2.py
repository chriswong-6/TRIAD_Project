...
incidence_input_np = incidence_1.loc[:,['Bmean','Bmedian','Bmax','Bmin']].values
...
incidence_output_np = incidence_1['incidence_1'].values
...
#print('-----------------------------------------------')
for r in range(len(ra)):
    result = train_data(ra[r],incidence_input_np,incidence_output_np)
    if r == 0:
        print('Sum the Valence')
        #print('Negative')
