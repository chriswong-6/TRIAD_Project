...
incidence_1 = dfmerge.loc[:,['incidence_1','nums','Num_mean','Bmean','Num_median','Bmedian','Num_max','Bmax','Num_min','Bmin']]
...
incidence_input1_np = incidence_input_1.loc[:,['Bmean','Bmedian','Bmax','Bmin']].values
incidence_input0_np = incidence_input_0.loc[:,['Bmean','Bmedian','Bmax','Bmin']].values
